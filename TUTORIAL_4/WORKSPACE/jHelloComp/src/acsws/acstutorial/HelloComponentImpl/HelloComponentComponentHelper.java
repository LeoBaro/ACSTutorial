...
import acsws.acstutorial.HelloComponentPOATie;
import acsws.acstutorial.HelloComponentImpl.HelloComponentImpl;
 ...
 * <p>
 * Name="HELLOCOMPONENT_1" Code="acsws.acstutorial.HelloComponentImpl.HelloComponentComponentHelper" Type="IDL:acsws/acstutorial/HelloComponent:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class HelloComponentComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public HelloComponentComponentHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return HelloComponentPOATie.class;
	}
	...
	*/
	...
	{
		return HelloComponentOperations.class;
	}
