...
import acsws.acstutorial.TelescopePOATie;
import acsws.acstutorial.TelescopeImpl.TelescopeImpl;
 ...
 * <p>
 * Name="TELESCOPE_1" Code="acsws.acstutorial.TelescopeImpl.TelescopeComponentHelper" Type="IDL:acsws/acstutorial/Telescope:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class TelescopeComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public TelescopeComponentHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return TelescopeOperations.class;
	}
